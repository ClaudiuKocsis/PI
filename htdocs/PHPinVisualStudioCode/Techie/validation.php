...
else
{
    ...
    header("refresh: 3; url = http://localhost/PHPinVisualStudioCode/Techie/forum_login.php?error=Your login credentials are incorect try again, redirecting to login form...");
